...
Utils::addRoute('courseTeacherList','CourseListCtrl');
...
Utils::addRoute('enrollmentStudentList',  'EnrollmentListCtrl');
Utils::addRoute('enrollmentTeacherList',  'EnrollmentListCtrl');
Utils::addRoute('enrollmentDelete',  'EnrollmentEditCtrl');
Utils::addRoute('enrollmentOK',  'EnrollmentEditCtrl');
Utils::addRoute('priceSet',  'EnrollmentEditCtrl');
